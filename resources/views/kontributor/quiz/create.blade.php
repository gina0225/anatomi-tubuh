...
<div x-data="{ tipe: 'pilihan_ganda' }" class="quiz-container">

    <!-- Tabs -->
    <div class="mb-3">
        <button class="tab-btn" :class="{ 'active': tipe === 'pilihan_ganda' }" @click="tipe = 'pilihan_ganda'">
            Pilihan Ganda
        </button>
    ...
    <!-- Form -->
    <form action="{{ route('kontributor.quiz.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <!-- nilai yg dikirim harus sesuai controller -->
        <input type="hidden" name="tipe"
            :value="tipe === 'pilihan_ganda' ? 'pilihan' : 'truefalse'">
        ...
        <div class="form-card">
            ...
            <!-- MODE PILIHAN GANDA -->
            <div x-show="tipe === 'pilihan_ganda'" x-transition>
                <div class="mb-3">
                    <label class="form-label">Jawaban Benar</label>
                    <input type="text" name="jawaban_benar" class="form-control"
                        :disabled="tipe !== 'pilihan_ganda'">
                </div>
